...
\usepackage{style/{{ cookiecutter.project_slug }}}
...
\copyrightyear{ {{ cookiecutter.year }} }
...
\author{ {{ cookiecutter.name }} \affil{1}{ {{ cookiecutter.affiliation }} },
Second Author\affil{2}{ Second Author Affiliation },
\and
Third Author\affil{2}{ Third Author Affiliation }}
...
\significancetext{ Lorem ipsum dolor sit amet, consectetur adipisicing elit,
...
for the surface quasi-geostrophic equation.  This is a sample citation to see
if it’s working~\cite{Mas12}.  This 2-D active scalar equation reads for the
...
transition layer of thickness smaller than $2\delta$ in which
 $\theta$ changes from 0 to 1. That means we are considering $\theta$  of the form
\[
...
\bibliography{bib/{{ cookiecutter.project_slug }}}
